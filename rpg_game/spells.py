...
POISON_CLOUD = Spell("Poison Cloud", "Destruction", magicka_cost=22, power=25, effect_type="damage", description="Releases a cloud of venom, poisoning foes.", status_effect="poison")
...
EARTH_SHIELD = Spell("Earth Shield", "Alteration", magicka_cost=20, power=15, effect_type="buff_defense", description="Summons an earthen barrier, increasing defense.")
